...
export function EventTimeline({ events, limit = 20 }: EventTimelineProps) {
  ...
  return (
    <section aria-label="Timeline de la semaine" data-section="timeline-semaine">
      <div className="glass rounded-2xl p-5">
        ...
        {events.length === 0 ? (
          ...
          <div className="space-y-3" role="list" aria-label="Jours de la semaine">
            {DAY_NAMES.map((name, idx) => {
              ...
              return (
                <div key={idx} role="listitem" data-day={name.toLowerCase()} className="flex gap-3">
                  {/* Day label */}
                  ...
                  {/* Timeline line */}
                  <div className="relative flex w-3 flex-col items-center" aria-hidden="true">
                    <div
