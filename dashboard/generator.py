...
def generate_html(
    ...
    hrv = _latest_metric(metrics_history, "hrv_sdnn", 0)
    sleep_h = _latest_metric(metrics_history, "sleep_h", 0)
    vo2max = _latest_metric(metrics_history, "vo2max", 0)
    steps = _latest_metric(metrics_history, "steps", 0)
    body_battery = _latest_metric(metrics_history, "body_battery", 0)
...
<div class="app">
  <div class="top">
    ...
    <div class="badges">
      <span class="badge">Apple Calendar: __CAL_STATUS__</span>
...
function openModal(ev) {
  ...
  if (ev) {
    ...
    document.getElementById('fType').value = 'cardio';
...
function initCharts() {
  chartLine('chartHours', PROG.hours.labels, PROG.hours.values, '#3b82f6', false);
  chartLine('chartRunKm', PROG.runKm.labels, PROG.runKm.values, '#10b981', false);
  chartLine('chart10k', PROG.tenk.labels, PROG.tenk.values, '#f97316', true);
  chartLine('chartVo2', PROG.vo2.labels, PROG.vo2.values, '#8b5cf6', false);
}
